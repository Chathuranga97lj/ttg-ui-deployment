...
import logo from "../../../../public/images/logo/nav-logo.webp";
...
export default function Footer() {
  ...
  const socialLinks = [
    {
      name: "Facebook",
      href: "https://web.facebook.com/BoostYourGradesWithTopTutors/",
      icon: (
    ...
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/company/top-tutors-global/?viewAsMember=true",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <footer className="bg-black text-gray-100">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="mb-4">
              <Image
                src={logo}
                alt="Top Tutors Global Logo"
                width={140}
                height={40}
                className="brightness-0 invert"
              />
            </div>
            <p className="caption-text md:p-regular-text text-gray-400 mb-6 leading-relaxed">
              Connecting learners with expert tutors worldwide. Get the academic
          ...
          {/* Quick Links */}
          <div>
            <h4 className="p-semi-bold-text text-white mb-4 md:mb-6">
              Quick Links
            </h4>
      ...
      <div className="border-t border-gray-800">
        <p className="caption-text text-gray-500 text-center py-5">
          © {currentYear} Top Tutors Global. All rights reserved.
        </p>
      </div>
    </footer>
  );
